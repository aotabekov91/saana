...
def synthesize_image(text, processes=[]):
...
def synthesize_anki_image(text, processes=[]):
    ...
    if os.path.isfile(image_path):
        return image_name, image_path
    return synthesize_image(text, processes)

def synthesize_sound(text, lan='en', processes=[]):
...
def synthesize_anki_sound(text, lan='en', processes=[]):
    ...
    if os.path.isfile(sound_path):
        return sound_name, sound_path
    return synthesize_sound(text, lan, processes)
